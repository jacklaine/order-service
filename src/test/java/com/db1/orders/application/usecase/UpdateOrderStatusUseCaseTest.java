...
class UpdateOrderStatusUseCaseTest extends AbstractIntegrationTest {
    ...
    void shouldConfirmOrder() {
        OrderItem item = new OrderItem("SN-001", "1", new BigDecimal("50.00"));
        Orders order = new Orders("CUST-001", "ORD-001", List.of(item));
    ...
    void shouldRejectOrder() {
        OrderItem item = new OrderItem("SN-002", "1", new BigDecimal("50.00"));
        Orders order = new Orders("CUST-002", "ORD-002", List.of(item));
